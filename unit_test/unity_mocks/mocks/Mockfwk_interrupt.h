...
#define fwk_interrupt_configure_IgnoreAndReturn(cmock_retval) fwk_interrupt_configure_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void fwk_interrupt_configure_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define fwk_interrupt_configure_StopIgnore() fwk_interrupt_configure_CMockStopIgnore()
void fwk_interrupt_configure_CMockStopIgnore(void);
#define fwk_interrupt_configure_ExpectAnyArgsAndReturn(cmock_retval) fwk_interrupt_configure_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void fwk_interrupt_configure_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define fwk_interrupt_configure_ExpectAndReturn(interrupt, cfg, cmock_retval) fwk_interrupt_configure_CMockExpectAndReturn(__LINE__, interrupt, cfg, cmock_retval)
...
typedef int (* CMOCK_fwk_interrupt_configure_CALLBACK)(unsigned int interrupt, unsigned int cfg, int cmock_num_calls);
...
#define fwk_interrupt_configure_StubWithCallback fwk_interrupt_configure_Stub
#define fwk_interrupt_configure_IgnoreArg_interrupt() fwk_interrupt_configure_CMockIgnoreArg_interrupt(__LINE__)
void fwk_interrupt_configure_CMockIgnoreArg_interrupt(UNITY_LINE_TYPE cmock_line);
#define fwk_interrupt_configure_IgnoreArg_cfg() fwk_interrupt_configure_CMockIgnoreArg_cfg(__LINE__)
...
#define fwk_interrupt_set_priority_IgnoreAndReturn(cmock_retval) fwk_interrupt_set_priority_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void fwk_interrupt_set_priority_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define fwk_interrupt_set_priority_StopIgnore() fwk_interrupt_set_priority_CMockStopIgnore()
void fwk_interrupt_set_priority_CMockStopIgnore(void);
#define fwk_interrupt_set_priority_ExpectAnyArgsAndReturn(cmock_retval) fwk_interrupt_set_priority_CMockExpectAnyArgsAndReturn(__LINE__, cmock_retval)
void fwk_interrupt_set_priority_CMockExpectAnyArgsAndReturn(UNITY_LINE_TYPE cmock_line, int cmock_to_return);
#define fwk_interrupt_set_priority_ExpectAndReturn(interrupt, val, cmock_retval) fwk_interrupt_set_priority_CMockExpectAndReturn(__LINE__, interrupt, val, cmock_retval)
...
typedef int (* CMOCK_fwk_interrupt_set_priority_CALLBACK)(unsigned int interrupt, unsigned int val, int cmock_num_calls);
...
#define fwk_interrupt_set_priority_StubWithCallback fwk_interrupt_set_priority_Stub
#define fwk_interrupt_set_priority_IgnoreArg_interrupt() fwk_interrupt_set_priority_CMockIgnoreArg_interrupt(__LINE__)
void fwk_interrupt_set_priority_CMockIgnoreArg_interrupt(UNITY_LINE_TYPE cmock_line);
#define fwk_interrupt_set_priority_IgnoreArg_val() fwk_interrupt_set_priority_CMockIgnoreArg_val(__LINE__)
