    ...
    [MCP_CFGD_MOD_TRANSPORT_EIDX_SCP_SCMI_MSG_SEND_CH] = {
        ...
        .data = &((
            struct mod_transport_channel_config) {
                ...
                /* TODO: Enable shutdown/reboot support for multichip platform
                 * as well, once chip to chip SCP communicaiton is enabled */
