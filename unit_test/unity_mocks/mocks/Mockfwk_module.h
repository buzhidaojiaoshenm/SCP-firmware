...
#define fwk_module_get_element_count_ExpectAndReturn(module_id, mod_elem_count, cmock_retval) fwk_module_get_element_count_CMockExpectAndReturn(__LINE__, module_id, mod_elem_count, cmock_retval)
void fwk_module_get_element_count_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, fwk_id_t module_id, size_t* mod_elem_count, int cmock_to_return);
typedef int (* CMOCK_fwk_module_get_element_count_CALLBACK)(fwk_id_t module_id, size_t* mod_elem_count, int cmock_num_calls);
...
#define fwk_module_get_element_count_ExpectWithArrayAndReturn(module_id, mod_elem_count, mod_elem_count_Depth, cmock_retval) fwk_module_get_element_count_CMockExpectWithArrayAndReturn(__LINE__, module_id, mod_elem_count, mod_elem_count_Depth, cmock_retval)
void fwk_module_get_element_count_CMockExpectWithArrayAndReturn(UNITY_LINE_TYPE cmock_line, fwk_id_t module_id, size_t* mod_elem_count, int mod_elem_count_Depth, int cmock_to_return);
#define fwk_module_get_element_count_ReturnThruPtr_mod_elem_count(mod_elem_count) fwk_module_get_element_count_CMockReturnMemThruPtr_mod_elem_count(__LINE__, mod_elem_count, sizeof(size_t))
#define fwk_module_get_element_count_ReturnArrayThruPtr_mod_elem_count(mod_elem_count, cmock_len) fwk_module_get_element_count_CMockReturnMemThruPtr_mod_elem_count(__LINE__, mod_elem_count, cmock_len * sizeof(*mod_elem_count))
#define fwk_module_get_element_count_ReturnMemThruPtr_mod_elem_count(mod_elem_count, cmock_size) fwk_module_get_element_count_CMockReturnMemThruPtr_mod_elem_count(__LINE__, mod_elem_count, cmock_size)
void fwk_module_get_element_count_CMockReturnMemThruPtr_mod_elem_count(UNITY_LINE_TYPE cmock_line, size_t* mod_elem_count, size_t cmock_size);
...
#define fwk_module_get_element_count_IgnoreArg_mod_elem_count() fwk_module_get_element_count_CMockIgnoreArg_mod_elem_count(__LINE__)
void fwk_module_get_element_count_CMockIgnoreArg_mod_elem_count(UNITY_LINE_TYPE cmock_line);
...
#define fwk_module_get_sub_element_count_ExpectAndReturn(mod_id, mod_sub_elem_cnt, cmock_retval) fwk_module_get_sub_element_count_CMockExpectAndReturn(__LINE__, mod_id, mod_sub_elem_cnt, cmock_retval)
...
typedef int (* CMOCK_fwk_module_get_sub_element_count_CALLBACK)(fwk_id_t mod_id, size_t* mod_sub_elem_cnt, int cmock_num_calls);
...
#define fwk_module_get_sub_element_count_ExpectWithArrayAndReturn(mod_id, mod_sub_elem_cnt, mod_sub_elem_cnt_Depth, cmock_retval) fwk_module_get_sub_element_count_CMockExpectWithArrayAndReturn(__LINE__, mod_id, mod_sub_elem_cnt, mod_sub_elem_cnt_Depth, cmock_retval)
...
#define fwk_module_get_sub_element_count_ReturnThruPtr_mod_sub_elem_cnt(mod_sub_elem_cnt) fwk_module_get_sub_element_count_CMockReturnMemThruPtr_mod_sub_elem_cnt(__LINE__, mod_sub_elem_cnt, sizeof(size_t))
#define fwk_module_get_sub_element_count_ReturnArrayThruPtr_mod_sub_elem_cnt(mod_sub_elem_cnt, cmock_len) fwk_module_get_sub_element_count_CMockReturnMemThruPtr_mod_sub_elem_cnt(__LINE__, mod_sub_elem_cnt, cmock_len * sizeof(*mod_sub_elem_cnt))
#define fwk_module_get_sub_element_count_ReturnMemThruPtr_mod_sub_elem_cnt(mod_sub_elem_cnt, cmock_size) fwk_module_get_sub_element_count_CMockReturnMemThruPtr_mod_sub_elem_cnt(__LINE__, mod_sub_elem_cnt, cmock_size)
...
#define fwk_module_get_sub_element_count_IgnoreArg_mod_id() fwk_module_get_sub_element_count_CMockIgnoreArg_mod_id(__LINE__)
void fwk_module_get_sub_element_count_CMockIgnoreArg_mod_id(UNITY_LINE_TYPE cmock_line);
#define fwk_module_get_sub_element_count_IgnoreArg_mod_sub_elem_cnt() fwk_module_get_sub_element_count_CMockIgnoreArg_mod_sub_elem_cnt(__LINE__)
