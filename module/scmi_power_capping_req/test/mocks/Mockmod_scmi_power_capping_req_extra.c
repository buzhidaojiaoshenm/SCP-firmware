...
typedef struct _CMOCK_start_alarm_api_CALL_INSTANCE
{
  ...
  cmock_mod_scmi_power_capping_req_extra_func_ptr1 Expected_callback;
...
static struct Mockmod_scmi_power_capping_req_extraInstance
{
...
void Mockmod_scmi_power_capping_req_extra_Verify(void)
{
...
void Mockmod_scmi_power_capping_req_extra_Init(void)
{
  Mockmod_scmi_power_capping_req_extra_Destroy();
}

void Mockmod_scmi_power_capping_req_extra_Destroy(void)
{
...
int start_alarm_api(fwk_id_t alarm_id, uint32_t microseconds, enum mod_timer_alarm_type type, cmock_mod_scmi_power_capping_req_extra_func_ptr1 callback, uintptr_t param)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
...
void CMockExpectParameters_start_alarm_api(CMOCK_start_alarm_api_CALL_INSTANCE* cmock_call_instance, fwk_id_t alarm_id, uint32_t microseconds, enum mod_timer_alarm_type type, cmock_mod_scmi_power_capping_req_extra_func_ptr1 callback, uintptr_t param);
void CMockExpectParameters_start_alarm_api(CMOCK_start_alarm_api_CALL_INSTANCE* cmock_call_instance, fwk_id_t alarm_id, uint32_t microseconds, enum mod_timer_alarm_type type, cmock_mod_scmi_power_capping_req_extra_func_ptr1 callback, uintptr_t param)
{
  ...
  memcpy((void*)(&cmock_call_instance->Expected_callback), (void*)(&callback),
         sizeof(cmock_mod_scmi_power_capping_req_extra_func_ptr1[sizeof(callback) == sizeof(cmock_mod_scmi_power_capping_req_extra_func_ptr1) ? 1 : -1])); /* add cmock_mod_scmi_power_capping_req_extra_func_ptr1 to :treat_as_array if this causes an error */
...
void start_alarm_api_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, fwk_id_t alarm_id, uint32_t microseconds, enum mod_timer_alarm_type type, cmock_mod_scmi_power_capping_req_extra_func_ptr1 callback, uintptr_t param, int cmock_to_return)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_start_alarm_api_CALL_INSTANCE));
  CMOCK_start_alarm_api_CALL_INSTANCE* cmock_call_instance = (CMOCK_start_alarm_api_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
