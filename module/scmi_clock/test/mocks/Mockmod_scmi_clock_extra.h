...
#define scmi_notification_notify_ExpectAndReturn(protocol_id, operation_id, resource_id, scmi_response_message_id, payload_p2a, payload_size, cmock_retval) scmi_notification_notify_CMockExpectAndReturn(__LINE__, protocol_id, operation_id, resource_id, scmi_response_message_id, payload_p2a, payload_size, cmock_retval)
...
typedef int (* CMOCK_scmi_notification_notify_CALLBACK)(unsigned int protocol_id, unsigned int operation_id, unsigned int resource_id, unsigned int scmi_response_message_id, void* payload_p2a, size_t payload_size, int cmock_num_calls);
...
#define scmi_notification_notify_IgnoreArg_resource_id() scmi_notification_notify_CMockIgnoreArg_resource_id(__LINE__)
