...
#ifndef _MOCKMOD_SCMI_POWER_CAPPING_REQ_EXTRA_H
#define _MOCKMOD_SCMI_POWER_CAPPING_REQ_EXTRA_H

#include "unity.h"
#include "mod_scmi_power_capping_req_extra.h"
...
typedef void(*cmock_mod_scmi_power_capping_req_extra_func_ptr1)(uintptr_t param);
...
typedef int (* CMOCK_start_alarm_api_CALLBACK)(fwk_id_t alarm_id, uint32_t microseconds, enum mod_timer_alarm_type type, cmock_mod_scmi_power_capping_req_extra_func_ptr1 callback, uintptr_t param, int cmock_num_calls);
